...
import { AnchorInterface, ButtonInterface, Color } from '../../interface';
...
export class Button implements ComponentInterface, AnchorInterface, ButtonInterface {
   ...
   */
  @Prop({ reflectToAttr: true, mutable: true }) fill?: 'clear' | 'outline' | 'solid' | 'default' = 'solid';
  ...
  private get hasIconOnly() {
    return !!this.el.querySelector('neo-icon[slot="icon-only"]');
  }
  ...
  render() {
    const { buttonType, fill, type, disabled, rel, target, size, href, color, expand, hasIconOnly, shape, strong } = this;
