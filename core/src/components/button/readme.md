...
| `fill`       | `fill`        | Set to `"clear"` for a transparent button, to `"outline"` for a transparent button with a border, or to `"solid"`. The default style is `"solid"` except inside of a toolbar, where the default is `"clear"`.                                                                             | `"clear" \| "default" \| "outline" \| "solid"` | `'solid'`   |
...
| ---------- | ------------------------------------ | ------------------- |
| `neoBlur`  | Emitted when the button loses focus. | `CustomEvent<void>` |
| `neoFocus` | Emitted when the button has focus.   | `CustomEvent<void>` |
