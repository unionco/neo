...
export class Input implements ComponentInterface {
  ...
  private inputId = `neo-input-${inputIds++}`;
  ...
  protected valueChanged() {
    this.emitStyle();
    this.neoChange.emit({ value: this.value });
  }
   ...
   */
  @Event() neoChange!: EventEmitter<InputChangeEventDetail>;
   ...
   * @internal
   */
  @Event() neoInputDidLoad!: EventEmitter<void>;

  /**
   * Emitted when the input has been removed.
   * @internal
   */
  @Event() neoInputDidUnload!: EventEmitter<void>;
  ...
  /**
   * Sets focus on the specified `neo-input`. Use this method instead of the global
   * `input.focus()`.
   */
  @Method()
  async setFocus() {
